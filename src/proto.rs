...
pub mod crashpilot;
pub use crashpilot::{
  Ball as CrashpilotBall, Command as CrashpilotCommand, GamePhase as CrashpilotGamePhase,
  Infos as CrashpilotInfos, InterfaceCommand as CrashpilotInterfaceCommand,
  InterfaceGame as CrashpilotInterfaceGame, InterfaceInput as CrashpilotInterfaceInput,
  InterfaceManual as CrashpilotInterfaceManual, InterfaceOutput as CrashpilotInterfaceOutput,
  InterfaceRobotCommand as CrashpilotInterfaceRobotCommand,
  InterfaceTest as CrashpilotInterfaceTest, Mode as CrashpilotMode, Robot as CrashpilotRobot,
  RobotFeedback as CrashpilotRobotFeedback, State as CrashpilotState, Task as CrashpilotTask,
  Tests as CrashpilotTests, TrackedRobot as CrashpilotTrackedRobot, Vector2 as CrashpilotVector2,
};
...
pub struct RobotSpecs {
  ...
  #[prost(message, repeated, tag = "14")]
  pub custom: ::prost::alloc::vec::Vec<::prost_types::Any>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct TeleportBall {
  ...
  pub by_force: ::core::option::Option<bool>,
}
...
pub struct SimulationSyncRequest {
  ...
  #[prost(float, optional, tag = "1")]
  pub sim_step: ::core::option::Option<f32>,
  /// An optional simulator command
  #[prost(message, optional, tag = "2")]
  pub simulator_command: ::core::option::Option<SimulatorCommand>,
  /// An optional robot control command
  #[prost(message, optional, tag = "3")]
  pub robot_control: ::core::option::Option<RobotControl>,
}
...
pub struct SimulationSyncResponse {
  ...
  #[prost(message, optional, tag = "2")]
  pub robot_control_response: ::core::option::Option<RobotControlResponse>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
